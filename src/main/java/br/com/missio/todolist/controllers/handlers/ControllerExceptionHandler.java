...
import br.com.missio.todolist.dto.ValidationError;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> methodArgumentNotValidation(MethodArgumentNotValidException ex, HttpServletRequest request) {
